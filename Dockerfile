...
COPY /lib/ojdbc8-19.3.0.0.jar ./home/lib/ojdbc8-19.3.0.0.jar
RUN mvn install:install-file -Dfile=/home/lib/ojdbc8-19.3.0.0.jar -DgroupId=com.oracle.jdbc -DartifactId=ojdbc8 -Dversion=19.3.0.0 -Dpackaging=jar
